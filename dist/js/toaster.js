(function (global, factory) {
    ...
    class Toaster {
        ...
        static serve() {
            ...
            (_a = this.currentToast) === null || _a === void 0 ? void 0 : _a.dispatchEvent(new Event('baked'));
            const next = (event) => {
            ...
            (_b = this.currentToast) === null || _b === void 0 ? void 0 : _b.addEventListener('transitionend', next);
        }
    }
    Toaster.version = "2.0.1";
    Toaster.toastQueue = [];
